...
public abstract class MessageRouter {
	...
	public static final int Q_MODE_HOPS = 3;
...
//	private HashMap<Group, Object> blacklistedMessages;
	...
	public int receiveMessage(Message m, DTNHost from) {
		...
		this.putToIncomingBuffer(newMessage, from);	// 保存到当前host的路由的Buffer中
		newMessage.addNodeOnPath(this.host); // message过了哪些节点进行记录
